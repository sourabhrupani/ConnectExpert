		...
		<div id="qam-topbar" class="clearfix">
			<div class="qam-main-nav-wrapper clearfix">
				...
				<div class="qam-account-items-wrapper">
					<div id="qam-account-toggle" class="qam-logged-in">
						<i class="icon-key qam-auth-key"></i>
						<div class="qam-account-handle">LogOut</div>
					</div>
				...
				<div class="qa-nav-main">
					<ul class="qa-nav-main-list">
						...
						<li class="qa-nav-main-item qa-nav-main-questions">
							<a href="questions.php" class="qa-nav-main-link qa-nav-main-selected">Questions</a>
						</li>
	...
	<form method="post" action="http://www.question2answer.org/qa/ask?cat=">
		...
		<input type="hidden" name="doask1" value="1">
					...
					<div class="qa-part-q-list">
						<form method="post" action="http://www.question2answer.org/qa/questions">
							<div class="qa-q-list">
									...
									<div class="qa-q-item-main">
										...
										<span class="qa-q-item-avatar-meta">
											<span class="qa-q-item-avatar">
												<a href="user/q2apro.html" class="qa-avatar-link"><img src="questions6569.jpg?qa=image&amp;qa_blobid=11666304965361404942&amp;qa_size=20" width="20" height="20" class="qa-avatar-image" alt=""></a>
											</span>
											<span class="qa-q-item-meta">
												...
												<span class="qa-q-item-where">
													<span class="qa-q-item-where-pad">in </span><span class="qa-q-item-where-data"><a href="questions/core.html" class="qa-category-link">Q2A Core</a></span>
												</span>
								...
								<div class="qa-q-list-item" id="q62759">
									...
									<div class="qa-q-item-main">
										...
										<span class="qa-q-item-avatar-meta">
											<span class="qa-q-item-avatar">
												<a href="user/craigg.html" class="qa-avatar-link"><img src="questions8eeb.jpg?qa=image&amp;qa_blobid=12697203736109131893&amp;qa_size=20" width="20" height="20" class="qa-avatar-image" alt=""></a>
											</span>
											<span class="qa-q-item-meta">
												<span class="qa-q-item-what">asked</span>
												<span class="qa-q-item-when">
								...
								<div class="qa-q-list-item" id="q62751">
									<div class="qa-q-item-stats">
										<div class="qa-voting qa-voting-net" id="voting_62751">
											<div class="qa-vote-buttons qa-vote-buttons-net">
												<input title="Click to vote up" name="vote_62751_1_q62751" onclick="return qa_vote_click(this);" type="submit" value="+" class="qa-vote-first-button qa-vote-up-button"> 
												<input title="Click to vote down" name="vote_62751_-1_q62751" onclick="return qa_vote_click(this);" type="submit" value="&ndash;" class="qa-vote-second-button qa-vote-down-button"> 
											</div>
											<div class="qa-vote-count qa-vote-count-net">
												<span class="qa-netvote-count">
									...
									<div class="qa-q-item-main">
										<div class="qa-q-item-title">
											...
											<a href="62751/how-to-change-password-policy-at-the-time-of-registration.html"><span title="So I want to provide a better security for users. to achieve this I need to ask users to put a Password of at least 6 character and should have at least 1 upper case. How can I do this from Admin Panel.">How to change password policy at the time of registration</span></a>
										</div>
										<span class="qa-q-item-avatar-meta">
											<span class="qa-q-item-avatar">
												<img src="questions8eeb.jpg?qa=image&amp;qa_blobid=12697203736109131893&amp;qa_size=20" width="20" height="20" class="qa-avatar-image" alt="">
											</span>
											<span class="qa-q-item-meta">
												<span class="qa-q-item-what">asked</span>
												<span class="qa-q-item-when">
													<span class="qa-q-item-when-data">19 hours</span><span class="qa-q-item-when-pad"> ago</span>
												</span>
												<span class="qa-q-item-where">
													<span class="qa-q-item-where-pad">in </span><span class="qa-q-item-where-data"><a href="questions/core.html" class="qa-category-link">Q2A Core</a></span>
												</span>
							...
							<div class="qa-q-list-form">
								<input type="hidden" name="code" value="0-1520521076-a040fb82833d64a793cead57ebba6f2b0e745d6b">
							</div>
						</form>
					</div>
					...
					<div class="qa-nav-cat">
						<ul class="qa-nav-cat-list qa-nav-cat-list-1">
							<li class="qa-nav-cat-item qa-nav-cat-all">
								<a href="questions/index.html" class="qa-nav-cat-link qa-nav-cat-selected">All categories</a>
							</li>
							<li class="qa-nav-cat-item qa-nav-cat-core">
								<a href="questions/core.html" class="qa-nav-cat-link" title="Questions about the Question2Answer platform.">Q2A Core</a>
								<span class="qa-nav-cat-note">(9,369)</span>
							</li>
							<li class="qa-nav-cat-item qa-nav-cat-plugins">
								<a href="questions/plugins.html" class="qa-nav-cat-link" title="Questions about plugins created for Q2A.">Plugins</a>
								<span class="qa-nav-cat-note">(2,738)</span>
							</li>
							<li class="qa-nav-cat-item qa-nav-cat-themes">
								<a href="questions/themes.html" class="qa-nav-cat-link" title="Questions about third-party themes.">Themes</a>
								<span class="qa-nav-cat-note">(557)</span>
							</li>
						</ul>
