...
<head>
	...
	<?php include 'header.php';?>
		...
		<div id="qam-topbar" class="clearfix navBar-Color">
			<div class="qam-main-nav-wrapper clearfix">
				...
				<div class="qam-account-items-wrapper">
					...
					<div class="qam-account-items clearfix">
						<form action="http://www.question2answer.org/qa/login?to=ask" method="post">
							<input type="text" name="emailhandle" dir="auto" placeholder="Email or Username">
							<input type="password" name="password" dir="auto" placeholder="Password">
							<div><input type="checkbox" name="remember" id="qam-rememberme" value="1">
							<label for="qam-rememberme">Remember</label></div>
							<input type="hidden" name="code" value="0-1520521081-29083538d8a98b9545c7ed3b20e453c2e2c9bf0d">
			...
			<div class="qa-main-wrapper">
				...
				<div class="qa-main">
					...
					<div class="qa-part-form">
						<form name="ask" method="post" action="http://www.question2answer.org/qa/ask">
								...
								<tr>
									<td class="qa-form-tall-label">
										...
										<select name="category_0" id="category_0" onchange="qa_category_select('category');" class="qa-form-tall-select">
											...
											<option value="Auronautical">Auronautical</option>
										</select>
									</td>
								</tr>
								<tr>
...
<!-- 								<tr>
								...
								<tr>
									<td class="qa-form-tall-data">
										...
										<div class="qa-form-tall-note">To avoid this verification in future, please <a href="login.html">log in</a> or <a href="register.html">register</a>.</div>
									</td>
								</tr>
								<tr>
									<td colspan="1" class="qa-form-tall-buttons">
										<input onclick="qa_show_waiting_after(this, false); if (qa_ckeditor_content) qa_ckeditor_content.updateElement();" value="Ask the Question" title="" type="submit" class="qa-form-tall-button qa-form-tall-button-ask">
									</td>
								</tr>
							</table>
							<input type="hidden" name="editor" value="WYSIWYG Editor">
							<input type="hidden" name="code" value="0-1520521081-0861f839228a3133f915ed5454bffde79b65d483">
